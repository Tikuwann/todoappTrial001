                ...
                <div class="flex justify-center bg-white overflow-hidden shadow-sm sm:rounded-lg">
                     ...
                     <div class="flex flex-wrap m-4">
                        ...
                        <div class="flex justify-center">
                            <div class="flex flex-col md:flex-row max-w-7xl justify-center items-center text-wrap "  style="width:20rem;">
                                <div
                                    class="bg-white m-4 shadow-xl vh-120 vw-90 flex flex-col justify-center text-black hover:border-t-8 hover:border-r-8 hover:border-yellow-500 rounded-lg transition duration-400 ease-in text-break">
...
{{-- uncompletedtask drag Start --}}
    ...
    <div class="py-12">
            ...
            <div class="bg-white  shadow-sm p-6 text-gray-900">
                Uncompleted Tasks
            </div>
            <div class="py-2">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">

            <div id="uncompletedtask" class="list-group">
            ...
            <script type="text/javascript">
                Sortable.create(uncompletedtask, { /* options */
                    group: 'shared', // set both lists to same group
                animation: 150
                });
                Sortable.create(completedtask, { /* options */
                    group: 'shared', // set both lists to same group
                animation: 150
                });
                </script>

{{-- uncompletedtask drag End --}}


{{-- completedtask drag Start --}}

            <script src="https://raw.githack.com/SortableJS/Sortable/master/Sortable.js"></script>

            <div id="completedtask" class="list-group">
                <div class="bg-white  shadow-sm p-6 text-gray-900">
                    Completed Tasks
                </div>
                @foreach ( $endtasks as $task)
