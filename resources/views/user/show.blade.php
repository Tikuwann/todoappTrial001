                ...
                <div class="flex justify-center w-full">
                    <div class="flex flex-col justify-center items-center max-w-7xl w-[90%]">
                        <div class="flex flex-col justify-center text-center space-y-1 my-9">
                            <h1 class="text-xl md:text-2xl font-semibold">Edit Task information</h1>
                            ...
                            <div
                                ...
                                <div class="flex flex-col justify-between lg:flex-row space-y-1 lg:space-y-0 ">
                                    ...
                                    <input type="text" name="task_name" id="task_name"
                                        class="bg-slate-100 rounded-lg px-2 py-1 placeholder:text-gray-600 w-[80%] lg:w-[60%] focus:border focus:outline-none focus:border-blue-500"value= "{{ $task -> task_name}}">
                                </div>

                                <div class="flex flex-col justify-between lg:flex-row space-y-1 lg:space-y-0">
                                    <h1>予定日時</h1>
                                    <input type="date" name="task_date" id="task_date"
                                        class="bg-slate-100 rounded-lg px-2 py-1 placeholder:text-gray-600 w-[80%] lg:w-[60%] focus:border focus:outline-none focus:border-blue-500" value="{{ $task -> task_date }}">
                                </div>

                                <div class="flex flex-col justify-between lg:flex-row space-y-1 lg:space-y-0">
                                    <h1>予定情報</h1>
                                    <textarea name="task_info" id="task_info" cols="10" rows="3"
                                        class="bg-slate-100 rounded-lg px-2 py-1 placeholder:text-gray-300 w-[80%] lg:w-[60%] focus:border focus:outline-none focus:border-blue-500" >{{ $task -> task_info }}</textarea>
                                </div>
                                <div class="text-center md:text-left lg:text-right">
                                    ...
                                    <button onclick="location.href='{{route('user.update', ['id' => $task -> id])}}" class="bg-blue-500 my- px-3 py-1 text-white rounded-md hover:bg-blue-600">send
                                    </button>
                                </div>
                            </div>
